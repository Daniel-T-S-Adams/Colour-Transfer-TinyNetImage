...
def pick_specific_images():
    ...
    target_path = all_images[78]    
    source_path = all_images[7000] 
...
def visualize_images(img_src, img_tgt, source_path, target_path, save_path="outputs/selected_images.png"):
    """
